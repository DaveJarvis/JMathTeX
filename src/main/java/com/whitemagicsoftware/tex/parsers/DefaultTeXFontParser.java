...
public class DefaultTeXFontParser {
    ...
    private static class ExtensionParser implements CharChildParser {
        ...
        throws ResourceParseException {
            ...
            extensionChars[ DefaultTeXFont.REP ] = parseIntElement( "rep", el );
            extensionChars[ DefaultTeXFont.TOP ] = parseOptionalInt( "top", el, DefaultTeXFont.NO_EXTENSION );
            extensionChars[ DefaultTeXFont.MID ] = parseOptionalInt( "mid", el, DefaultTeXFont.NO_EXTENSION );
            extensionChars[ DefaultTeXFont.BOT ] = parseOptionalInt( "bot", el, DefaultTeXFont.NO_EXTENSION );
    ...
    static {
        rangeTypeMappings.put( "numbers", DefaultTeXFont.NUMBERS);
        rangeTypeMappings.put( "capitals", DefaultTeXFont.CAPITALS);
        rangeTypeMappings.put( "small", DefaultTeXFont.SMALL);
        rangeTypeMappings.put( "unicode", DefaultTeXFont.UNICODE);
    }
    ...
    throws ResourceParseException {
        ...
        metrics[ DefaultTeXFont.WIDTH ] = parseOptionalFloat( "width", charElement, 0 );
        metrics[ DefaultTeXFont.HEIGHT ] = parseOptionalFloat( "height", charElement, 0 );
        metrics[ DefaultTeXFont.DEPTH ] = parseOptionalFloat( "depth", charElement, 0 );
        metrics[ DefaultTeXFont.ITALIC ] = parseOptionalFloat( "italic", charElement, 0 );
        // set metrics
