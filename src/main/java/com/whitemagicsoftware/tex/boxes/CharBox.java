...
import static com.whitemagicsoftware.tex.TeXFormula.FONT_SCALE_FACTOR;
import static com.whitemagicsoftware.tex.TeXFormula.PREC;
...
public final class CharBox extends Box {
  ...
  public void draw( final Graphics2D g, final float x, final float y ) {
    ...
    g.setFont( FontInfo.getFont( c.getFontId() ) );
