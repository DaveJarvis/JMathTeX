...
import be.ugent.caagt.jmathtex.resources.UnicodeResourceReader;
 ...
 * corresponding "build" method in the class {@code org.jdom2.input.SaxBuilder}.
...
public class MathMLParser {
    ...
    */
    ...
    throws ResourceParseException {
        ...
        try {
            return hexaToChar( unicode.substring( 2 ) );
    ...
    */
    private static void loadUnicodeMappings() throws ResourceParseException {
        Properties p = new UnicodeResourceReader( RESOURCE_NAME ).read();
        for( final String name : p.stringPropertyNames() ) {
          entities.put( convertToChar(name), p.getProperty( name ) );
        }
    }
