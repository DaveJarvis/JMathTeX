 ...
 * that created it.
 * <p>
 * This class must be instantiated from a TeXFormula using the
 * {@link TeXFormula#createTeXIcon(int, float)} method.
 *
...
public class TeXIcon implements Icon {
   ...
   * current
   * width, otherwise the icon will remain unchanged. The formula will be
   * aligned to the
  ...
  /**
   * Change the height of the TeXIcon. The new height must be greater than
   * the current
   * height, otherwise the icon will remain unchanged. The formula will be
   * aligned on top
   * (TeXConstants.TOP), at the bottom (TeXConstants.BOTTOM) or will be
   * centered
