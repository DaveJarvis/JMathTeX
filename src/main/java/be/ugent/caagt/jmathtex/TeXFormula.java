...
import be.ugent.caagt.jmathtex.parsers.PredefinedTeXFormulaParser;
import be.ugent.caagt.jmathtex.parsers.TeXFormulaSettingsParser;
...
public class TeXFormula {
    ...
    */
     ...
     * <p>
     * <b>It's recommended to use one of the other more simple "addAcc"-methods that require
     * the symbol name of the accent as a string! This method was added only because it was the
    ...
    */
    ...
    public TeXIcon createTeXIcon(int style, float size) {
      return new TeXIcon( createBox( new TeXEnvironment(
    ...
    */
     ...
     * puts it above the delimiter symbol (separated by an amount of vertical space defined
     ...
     * it under the delimiter symbol (separated by an amount of vertical space defined
     * by the given float value and unit) in a smaller size (unless the current TeXFormula
     * will be displayed in the smallest possible size: the script_script style's size)
     * and finally changes the current TeXFormula into the resulting construction.
     *
     ...
     * depending on "overScriptSize" and separated by a vertical space of size
     ...
     * in a smaller size
     * depending on "underScriptSize" and separated by a
