...
abstract class Atom {
    ...
    */
   protected int type = TYPE_ORDINARY;
   ...
   public int getRightType() {
    ...
    /**
     * Answers whether the given type matches the internal type.
     *
     * @param type A type value from {@link TeXConstants}
     * @return {@code true} if this atom represents the given type of macro.
     */
